...
bACK1 = new JoystickButton(xbox2, 7);
bACK1.whenPressed(new CloseShooterSet());
sTART1 = new JoystickButton(xbox2, 8);
sTART1.whenPressed(new FarShooterSet());
...
lBumper.whenPressed(new Shift());
        ...
        SmartDashboard.putData("FiveBallAuton", new FiveBallAuton());
        SmartDashboard.putData("ThreeBallAutonAndGrabbingTwoBalls", new ThreeBallAutonAndGrabbingTwoBalls());
        SmartDashboard.putData("ShootingAtLineThenMove", new ShootingAtLineThenMove());
        SmartDashboard.putData("CloseShooterSet", new CloseShooterSet());
        SmartDashboard.putData("FarShooterSet", new FarShooterSet());
        SmartDashboard.putData("SixBallAutonContinuousShooter", new SixBallAutonContinuousShooter());
